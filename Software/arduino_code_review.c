...
char calin_i[8] = '00000000'; // Taken out from voide loop
char calin_g[3] = '000';
...
void loop()
{
    ...
    if (Serial.available() > 0)
    {
        ...
        case 'F': // phi1, phi2, phi3 Frequency setup
        {
            ...
            if (freq_scale < 5)
            {
                REG_PWM_CLK = PWM_CLK_PREA(freq_scale) | PWM_CLK_DIVA(21);
            }
            //if ferq_scale=1 then phi1=phi2=33.33 kHz and phi3=500 kHz, if ferq_scale=2 then phi1=phi2=16.66 kHz and phi3=250 kHz,
            ...
            } // if ferq_scale=5 then phi1=phi2=140 kHz and phi3=2.1 MHz
            else if (freq_scale == 6)
            {
                REG_PWM_CLK = PWM_CLK_PREA(0) | PWM_CLK_DIVA(5);
            } // if ferq_scale=6 then phi1=phi2=280 kHz and phi3=4.2 MHz
            break;
        }
        default:
        {
